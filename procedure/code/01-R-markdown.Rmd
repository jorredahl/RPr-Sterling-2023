...
After performing AWR on the HOLC polygons, we are left with significantly less geometries than we started with (10154 originally vs. 9614 after re-aggregation). I am not sure why, and we should likely figure it out. 
...
data_clean <- HOLC_polygons |>
  mutate(
    holc_id = area_id,
    holc_grade = grade,
    black_pct = black_popE,
    White_pop = white_popE,
    Indig_pop = ind_popE,
    Asian_pop = asian_popE,
    Hispan_Latino_pop = hisp_popE / total_pop_hispE,
    pct_below_poverty = total_pop_plE,
    pct_home_ownership = total_ownE,
    pct_renters = total_rentE,
    pct_mobile_homes = total_mhE / total_hu_mhE,
    pct_pre_1980 = age_1939E + age_1940E + age_1950E + age_1960E + age_1970E,
    pct_post_1980 = age_1980E + age_1990E + age_2000E + age_2010E + age_2014E,
    pct_complete_plumb = c_plumbE / total_hu_plumbE,
    pct_incomplete_plumb = ic_plumbE / total_hu_plumbE,
