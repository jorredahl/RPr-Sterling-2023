...
data_clean_selected <- data_clean |>
  ...
  mutate(holc_grade_A = case_when(holc_grade == "A"~1.0,
                                  TRUE~0.0),
         holc_grade_B = case_when(holc_grade == "B"~1.0,
                                  TRUE~0.0),
         holc_grade_C = case_when(holc_grade == "C"~1.0,
                                  TRUE~0.0),
         holc_grade_D = case_when(holc_grade == "D"~1.0,
                                  TRUE~0.0)) |>
...
initial_model <- glm(pct_incomplete_plumb~.,family = binomial, data = data_clean_binary)
```
