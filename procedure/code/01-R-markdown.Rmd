...
Results used Average Marginal Effects (AME) using the $margins$ package to gather different census-derived variables represented as binary values. Here, the results of the reproduction's model are compared with that of the original model.
